...
use \Exception;
use \PDO;
use App\Models\MigrationsQuery as ChildMigrationsQuery;
use App\Models\Map\MigrationsTableMap;
...
abstract class Migrations implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\App\\Models\\Map\\MigrationsTableMap';
    ...
    /**
     * Initializes internal state of App\Models\Base\Migrations object.
     */
     ...
     * @return $this|\App\Models\Migrations The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\App\\Models\\Migrations'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\App\Models\Migrations
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\App\Models\Migrations The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \App\Models\Migrations (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \App\Models\Migrations Clone of current object.
     * @throws PropelException
     */
