...
use \Exception;
use \PDO;
use App\Models\Migrations as ChildMigrations;
...
abstract class MigrationsQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \App\Models\Base\MigrationsQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\App\\Models\\Migrations', $modelAlias = null)
    {
