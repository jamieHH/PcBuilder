...
class UsersTableMap extends TableMap
{
     ...
     */
    const OM_CLASS = '\\App\\Models\\Users';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(UsersTableMap::COL_ID, UsersTableMap::COL_NAME, UsersTableMap::COL_EMAIL, UsersTableMap::COL_PASSWORD, UsersTableMap::COL_REMEMBER_TOKEN, UsersTableMap::COL_CREATED_AT, UsersTableMap::COL_UPDATED_AT, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(UsersTableMap::COL_ID => 0, UsersTableMap::COL_NAME => 1, UsersTableMap::COL_EMAIL => 2, UsersTableMap::COL_PASSWORD => 3, UsersTableMap::COL_REMEMBER_TOKEN => 4, UsersTableMap::COL_CREATED_AT => 5, UsersTableMap::COL_UPDATED_AT => 6, ),
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\App\\Models\\Users');
        $this->setPackage('');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \App\Models\Users) { // it's a model object
