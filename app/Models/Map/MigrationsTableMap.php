...
use App\Models\MigrationsQuery;
...
class MigrationsTableMap extends TableMap
{
     ...
     */
    const OM_CLASS = '\\App\\Models\\Migrations';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\App\\Models\\Migrations');
        $this->setPackage('');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \App\Models\Migrations) { // it's a model object
