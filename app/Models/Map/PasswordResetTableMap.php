...
use App\Models\PasswordResetQuery;
...
class PasswordResetTableMap extends TableMap
{
     ...
     */
    const OM_CLASS = '\\App\\Models\\PasswordReset';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(PasswordResetTableMap::COL_EMAIL, PasswordResetTableMap::COL_TOKEN, PasswordResetTableMap::COL_CREATED_AT, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(PasswordResetTableMap::COL_EMAIL => 0, PasswordResetTableMap::COL_TOKEN => 1, PasswordResetTableMap::COL_CREATED_AT => 2, ),
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\App\\Models\\PasswordReset');
        $this->setPackage('');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \App\Models\PasswordReset) { // it's a model object
